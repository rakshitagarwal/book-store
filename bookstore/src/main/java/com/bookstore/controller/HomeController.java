...
import com.bookstore.utility.INConstants;
...
public class HomeController {
	...
	@RequestMapping("/authorInFocus")
	public String authorInFocus() {
		return "authorInFocus";
	}
	...
	@RequestMapping("/preowned")
	public String preowned(Model model, Principal principal) {
		if(principal != null) {
			String username = principal.getName();
			User user = userService.findByUsername(username);
			model.addAttribute("user", user);
